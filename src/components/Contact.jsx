    ...
    >
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            <h3 className="text-2xl font-semibold text-white mb-8">Contact Details</h3>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a 
                    href="mailto:Vishalkrbns586@gmail.com" 
                    className="text-gray-300 hover:text-white transition-colors"
                  >
                    Vishalkrbns586@gmail.com
                  </a>
                </div>
              </div>
            ...
            <div className="mt-12">
              ...
              <div className="flex gap-4">
                <a 
                  href="https://www.linkedin.com/in/vishal-kumar-29093726b/"
                  target="_blank" 
                ...
                <a 
                  href="https://github.com/Vishal586" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="p-3 bg-gray-700/50 rounded-lg border border-gray-600/30 hover:bg-purple-900/30 hover:border-purple-500/30 transition-all"
                  aria-label="GitHub"
                ...
                <a 
                  href="https://leetcode.com/u/vishalkr586/" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="p-3 bg-gray-700/50 rounded-lg border border-gray-600/30 hover:bg-purple-900/30 hover:border-purple-500/30 transition-all"
                  aria-label="LeetCode"
                ...
                <a 
                  href="https://www.geeksforgeeks.org/user/vishalkrdowu/" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="p-3 bg-gray-700/50 rounded-lg border border-gray-600/30 hover:bg-purple-900/30 hover:border-purple-500/30 transition-all"
                  aria-label="GeeksforGeeks"
                >
                  <SiGeeksforgeeks className="text-gray-300 hover:text-white" />
                </a>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="space-y-6">
              ...
              <div>
                <label htmlFor="message" className="block text-sm font-medium text-purple-300 mb-2">Your Message</label>
                <textarea
                  id="message"
                  name="message"
                  rows="5"
